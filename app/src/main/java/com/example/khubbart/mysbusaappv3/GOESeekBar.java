...
public class GOESeekBar extends android.support.v7.widget.AppCompatSeekBar {
    ...
    public GOESeekBar(Context context) {
        super(context);
        isTextVisible = false;
        Log.i("SeekerBar 111", formatter);
    ...
    //IS THIS METHOD EVER USED?
    public GOESeekBar(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        isTextVisible = false;
        Log.i("SeekerBar 222", formatter);
     ...
     */
    public GOESeekBar setMultiplier(int m) {
        multiplier = m;
        return this;
    }
    /*
    ...
    if-else statements
     */
    public GOESeekBar setFormatter(String f) {
        formatter = f;
        return this;
    }
    /*
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        tempDouble = getProgress()*multiplier-50.0;
        progressText = Double.toString(tempDouble/10);
        Log.i("We have SeekerBar Animation", progressText);
        Rect bounds = new Rect();
        tempInt = getResources().getColor(R.color.white);
        mTextPaint.setColor(tempInt);
        ...
        */
        mTextPaint.setTextSize(getResources().getDimensionPixelSize(R.dimen.textTiny)-getResources().getDimensionPixelSize(R.dimen.textSmall)*(progressText.length()));
